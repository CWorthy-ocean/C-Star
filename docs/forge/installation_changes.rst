.. _forge-installation-changes:

Installation changes (August 2026)
===================================
...
.. note::
   ...
   :doc:`../installation`. It still refers to the ``cstar-forge`` package, its developer
...
- **Plain-conda lockfile replay**: each release publishes explicit-spec +
  ...
  :ref:`reproducible-installs-lockfile`.
