...
class TestRomsMarblInputDataGeneration:
    ...
    @patch('cson_forge.input_data.rt.make_nesting_info')
    @patch('cson_forge.input_data.rt.Grid')
    def test_generate_grid_with_child(self, mock_grid_class, mock_make_nesting_info, sample_roms_marbl_input_data, tmp_path):
    ...
    @patch('cson_forge.input_data.rt.make_nesting_info')
    @patch('cson_forge.input_data.rt.Grid')
    def test_generate_grid_extract_file_is_basename(self, mock_grid_class, mock_make_nesting_info, sample_roms_marbl_input_data, tmp_path):
