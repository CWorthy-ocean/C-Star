...
class LiveStep(Step):
    ...
    working_directory: Path | None = Field(default=None, exclude=True)
    ...
    def get_working_dir(self) -> Path:
        if self.working_directory is None:
            ...
            self.working_directory = root_fsm.tasks_dir / self.safe_name
    ...
    def from_step(
        ...
        if effective_parent is not None:
            step_attrs.pop("working_directory", None)
