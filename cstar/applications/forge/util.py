...
def compute_timestep_from_cfl(
    ...
    if mode == "baroclinic":
        ...
        raise ValueError(f"'mode' must be 'baroclinic' or 'barotropic'; got {mode!r}")
    ...
    dt_original = round(dt)  # Ensure integer
...
# --- memory / timing instrumentation (formerly cstar_forge.utils) ----------
