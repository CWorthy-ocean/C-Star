...
ENV_FF_CLI_MANAGE_CACHE: t.Annotated[
    t.Literal["CSTAR_FF_CLI_MANAGE_CACHE"],
    EnvVar(
        "Enable CLI for promoting cache entries from user to group-level cache.",
        GROUP_FF,
        default=FLAG_OFF,
    ),
] = "CSTAR_FF_CLI_MANAGE_CACHE"
"""Enable CLI for promoting cache entries from user to group-level cache."""
