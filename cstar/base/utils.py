...
def _update_user_dotenv(env_file_str) -> None:
    log.info("Updating environment in C-Star configuration file ~/.cstar.env")
...
def _clone_and_checkout(
    ...
    log.info(f"Cloned repository {source_repo} to {local_path}")
    ...
    log.info(f"Checked out {checkout_target} in git repository {local_path}")
