...
class JobFileSystemManager(LoggingMixin):
    ...
    def input_dir(self) -> Path:
        ...
        """
        return self.working_dir / self._INPUT_NAME
    ...
    def run_dir(self) -> Path:
        ...
        system.
        """
        return self.working_dir / self._WORK_NAME
    ...
    def tasks_dir(self) -> Path:
        ...
        """
        return self.working_dir / self._TASKS_NAME

    @property
    def logs_dir(self) -> Path:
        """The directory for log files created during the job."""
        return self.working_dir / self._LOGS_NAME

    @property
    def output_dir(self) -> Path:
        """The directory for writing any outputs from the job."""
        return self.working_dir / self._OUTPUT_NAME
    ...
    def clear(self) -> None:
        ...
        msg = f"Emptying working directories for job `{self.working_dir.name}`"
        self.log.debug(msg)
    ...
    def clear_prior(self) -> None:
        ...
        msg = f"Emptying working directories of outputs for previous run of `{self.working_dir.name}`"
        self.log.debug(msg)
...
class RomsFileSystemManager(JobFileSystemManager):
    ...
    def joined_output_dir(self) -> Path:
        ...
        return self.working_dir / self._JOINED_OUTPUT_NAME
