...
class JobFileSystemManager(LoggingMixin):
    ...
    def input_dir(self) -> Path:
        ...
        """
        return self.working_directory / self._INPUT_NAME
    ...
    def run_dir(self) -> Path:
        ...
        system.
        """
        return self.working_directory / self._WORK_NAME
    ...
    def tasks_dir(self) -> Path:
        ...
        """
        return self.working_directory / self._TASKS_NAME
    ...
    def clear(self) -> None:
        ...
        msg = f"Emptying working directories for job `{self.working_directory.name}`"
        self.log.debug(msg)
    ...
    def clear_prior(self) -> None:
        ...
        msg = f"Emptying working directories of outputs for previous run of `{self.working_directory.name}`"
        self.log.debug(msg)
...
class RomsFileSystemManager(JobFileSystemManager):
    ...
    def joined_output_dir(self) -> Path:
        ...
        return self.working_directory / self._JOINED_OUTPUT_NAME
