...
def blueprint_path(
    ...
    simulation.to_blueprint(blueprint_path)
...
def sim_runner(
    ...
    simulation.to_blueprint(bp_path)
...
def test_runner_directory_prep(
    ...
    CSTAR_USER_ENV_PATH.parent.mkdir(parents=True, exist_ok=True)
    CSTAR_USER_ENV_PATH.touch()
    ...
    assert not CSTAR_USER_ENV_PATH.exists()
