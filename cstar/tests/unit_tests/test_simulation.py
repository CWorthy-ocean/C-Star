...
class TestSimulationInitialization:
    ...
    def test_validate_date_range_start_date_too_early(
        self, tmp_path, fake_externalcodebase_with_mock_source
    ):
        ...
        - `fake_externalcodebase_with_mock_source`: an ExternalCodeBase instance without filesystem or network logic
        ...
        with pytest.raises(
            ...
            StubSimulation(
                name="InvalidSim",
                directory=tmp_path,
                codebase=fake_externalcodebase_with_mock_source,
    ...
    def test_validate_date_range_end_date_too_late(
        self, fake_externalcodebase_with_mock_source, tmp_path
    ):
    ...
    def test_simulation_initialization_valid(
        self, fake_externalcodebase_with_mock_source
    ):
    ...
    def test_simulation_uses_fallback_dates(
        ...
        fake_externalcodebase_with_mock_source
