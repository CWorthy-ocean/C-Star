...
class TestMARBLExternalCodeBaseConfigure:
    def test_configure_success(
        self, mock_marblexternalcodebase_staged, dotenv_path, tmp_path
    ):
        """Test that the _configure method succeeds when subprocess calls succeed."""
        mecb = mock_marblexternalcodebase_staged
        marbl_path = tmp_path
        with (
    ...
    def test_make_failure(
        self, mock_subprocess, mock_marblexternalcodebase_staged, tmp_path, dotenv_path
    ):
    ...
    def test_is_configured_when_configured(
        ...
        with (
            ...
            assert mock_marblexternalcodebase_staged.is_configured
    ...
    def test_is_configured_variants(
        ...
        with (
            ...
            assert mock_marblexternalcodebase_staged.is_configured is expected
