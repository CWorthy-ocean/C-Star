...
class TestROMSSimulationInitialization:
    ...
    def test_init(self, fake_roms_simulation):
        ...
        Mocks & Fixtures
        ----------------
        - `fake_roms_simulation` : Provides a pre-configured `ROMSSimulation` instance
          and its corresponding directory.
        """
        sim, directory = fake_roms_simulation
    ...
    def test_find_dotin_file(self, fake_roms_simulation):
        """Test that the `_find_dotin_file` helper function correctly finds and sets the
        `_in_file` non-public attribute to the `.in` file.
        """
        sim, _ = fake_roms_simulation
        assert sim._in_file == "file2.in"

    def test_find_dotin_file_raises_if_no_dot_in_files(self, fake_roms_simulation):
    ...
    def test_codebases(self, fake_roms_simulation):
        ...
        Mocks & Fixtures
        ----------------
        - `fake_roms_simulation` : A fixture providing an initialized
    ...
    def test_forcing_paths(self, mock_path_for_roms, fake_roms_simulation):
    ...
    def test_forcing_paths_raises_if_path_missing(self, fake_roms_simulation):
        sim, _ = fake_roms_simulation
        with pytest.raises(FileNotFoundError):
            sim._forcing_paths

    def test_n_time_steps(self, fake_roms_simulation):
        sim, _ = fake_roms_simulation
    ...
    def test_roms_runtime_settings(
        ...
        Fixtures
        --------
        fake_roms_simulation: ROMSSimulation
    ...
    def test_input_datasets(self, fake_roms_simulation):
    ...
    def test_check_inputdataset_dates_warns_and_sets_start_date(
        self, fake_roms_simulation, caplog
    ):
        ...
        Mocks & Fixtures
        ----------------
        fake_roms_simulation (cstar.roms.ROMSSimulation)
    ...
    def test_check_inputdataset_partitioning(
        self, mock_source_partitioning, fake_roms_simulation
    ):
...
class TestStrAndRepr:
    ...
    Mocks & Fixtures
    ----------------
    - `fake_roms_simulation`: A fixture providing an initialized `ROMSSimulation`
    ...
    def test_str(
        self, mock_runtime_settings, mock_exists_locally, fake_roms_simulation
    ):
        ...
        - `fake_roms_simulation` : A fixture providing an initalized `ROMSSimulation`
           instance
...
Is setup: False"""
    ...
    def test_repr(self, fake_roms_simulation):
...
forcing_corrections = <list of 1 ROMSForcingCorrections instances>
    ...
    def test_tree(self, fake_roms_simulation, log: logging.Logger):
...
class TestToAndFromDictAndBlueprint:
    ...
    def setup_method(self):
        ...
        associated with the `fake_roms_simulation` fixture to be used across tests in
        this class.
        """
    ...
    def test_to_dict(self, fake_roms_simulation):
        ...
        Mocks & Fixtures
        ---------------------
        - `fake_roms_simulation`: A fixture providing a pre-configured `ROMSSimulation` instance.
        """
        sim, directory = fake_roms_simulation
    ...
    def test_from_dict(self, fake_roms_simulation):
    ...
    def test_dict_roundtrip(self, fake_roms_simulation):
    ...
    def test_to_blueprint(self, fake_roms_simulation):
    ...
    def test_blueprint_roundtrip(self, fake_roms_simulation, tmp_path):
        ...
        Mocks & Fixtures
        ----------------
        - `fake_roms_simulation`: A fixture providing a sample `ROMSSimulation` instance.
...
class TestProcessingAndExecution:
    ...
    def test_build(self, mock_subprocess, mock_get_hash, fake_roms_simulation):
        """Tests that `build` correctly compiles the ROMS executable.
    ...
    def test_build_raises_if_make_clean_error(
        self, mock_subprocess, mock_get_hash, fake_roms_simulation
    ):
    ...
    def test_build_raises_if_no_build_dir(self, fake_roms_simulation):
    ...
    def test_pre_run(self, mock_partition, fake_roms_simulation):
    ...
    def test_run_raises_if_no_runtime_code_working_path(self, fake_roms_simulation):
    ...
    def test_run_raises_if_no_executable(self, fake_roms_simulation):
    ...
    def test_run_raises_if_no_node_distribution(self, fake_roms_simulation):
    ...
    def test_run_local_execution(
        self, mock_runtime_settings, mock_persist, fake_roms_simulation
    ):
    ...
    def test_run_with_scheduler_raises_if_no_account_key(
        self, mock_runtime_settings, fake_roms_simulation
    ):
    ...
    def test_post_run_raises_if_called_before_run(self, fake_roms_simulation):
    ...
    def test_post_run_raises_if_still_running(self, fake_roms_simulation):
    ...
    def test_post_run_merges_netcdf_files(
        self, mock_subprocess, mock_persist, fake_roms_simulation
    ):
    ...
    def test_post_run_raises_error_if_ncjoin_fails(
        self, mock_glob, mock_subprocess, fake_roms_simulation
    ):
...
class TestROMSSimulationRestart:
    ...
    @patch.object(Path, "exists", return_value=True)
    def test_restart(self, mock_exists, mock_glob, fake_roms_simulation):
    ...
    def test_restart_raises_if_no_restart_files(
        self, mock_exists, mock_glob, fake_roms_simulation
    ):
    ...
    def test_restart_raises_if_multiple_restarts_found(
        self, mock_glob, fake_roms_simulation
    ):
