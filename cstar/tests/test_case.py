...
class TestWarningsAndErrors:
    ...
    @pytest.mark.parametrize("case_params, warning_message", [
    ...
    def test_case_init_valid_date_warnings(self, case_params, warning_message):
        ...
        assert (case.valid_start_date is None if "start date" in warning_message
    ...
    @pytest.mark.parametrize("case_params, error_message", [
        ({"end_date": "2023-01-31"}, "Neither start_date nor valid_start_date provided."),
        ({"start_date": "2023-01-01"}, "Neither end_date nor valid_end_date provided.")
    ])
    def test_case_init_missing_dates(self, case_params, error_message):
        """Test if ValueErrors are raised when neither start_date nor end_date is provided."""
